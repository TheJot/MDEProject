...
public class GenerateMeParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, GenerateMeGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getGenerateMeProgramAccess().getBusinessNameAssignment_1(), "rule__GenerateMeProgram__BusinessNameAssignment_1");
			builder.put(grammarAccess.getGenerateMeProgramAccess().getConfigAssignment_2(), "rule__GenerateMeProgram__ConfigAssignment_2");
			builder.put(grammarAccess.getGenerateMeProgramAccess().getHomePageAssignment_3(), "rule__GenerateMeProgram__HomePageAssignment_3");
			builder.put(grammarAccess.getGenerateMeProgramAccess().getPagesAssignment_4(), "rule__GenerateMeProgram__PagesAssignment_4");
			builder.put(grammarAccess.getConfigAccess().getSenderAssignment_1(), "rule__Config__SenderAssignment_1");
			builder.put(grammarAccess.getConfigAccess().getAuthorAssignment_3(), "rule__Config__AuthorAssignment_3");
			builder.put(grammarAccess.getHomePageAccess().getIntroductionAssignment_1(), "rule__HomePage__IntroductionAssignment_1");
